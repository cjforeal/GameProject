...
public class Player3Control : BasicPlayer
{
    ...
    private void Awake()
    {
        ...
        rigidBody.position = new Vector3(-2.480000021f, -1.560000002f, 0);
    ...
    void Start()
    {
        ...
        LoadTile("Yellow/NO else/Yellow", 0, 0);
        LoadTile("Yellow/Two/SameSide/Yellow_UpDown", 2, 0);
        LoadTile("Yellow/Two/SameSide/Yellow_LeftRight", 2, 1);
        LoadTile("Yellow/Four/Yellow", 4, 0);
        playerFlag = PlayerFlag.Player3;
