...
public class Player2Control : BasicPlayer
{
    ...
    void Start()
    {
        ...
        LoadTile( "Red/NO else/Pink", 0, 0);
        LoadTile( "Red/Two/SameSide/Pink_UpDown", 2, 0);
        LoadTile( "Red/Two/SameSide/Pink_LeftRight", 2, 1);
        LoadTile( "Red/Four/Pink", 4, 0);
